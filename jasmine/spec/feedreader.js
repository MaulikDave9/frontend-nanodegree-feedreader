    ...
    */
    ...
    describe('Initial Entries', function() {
         ...
         */
         ...
         it('after loadFeed call there is at least a single entry in the feed container', function(cb) {
            
            var entry = $('.entry');
            expect(entry.length).not.toBe(0); //at least one .entry element in .feed
            cb();
        });
